...
class ROSGen2Controller : public SimpleController
{
    ros::NodeHandle node;
...
public:
    ...
    virtual bool initialize(SimpleControllerIO* io) override
    {
        ...
        gen2Subscriber = node.subscribe("/j2s7s300_driver/in/joint_velocity", 2, &ROSGen2Controller::gen2Callback, this);
...
CNOID_IMPLEMENT_SIMPLE_CONTROLLER_FACTORY(ROSGen2Controller)
